    ...
    <div className="trip-page">
      ...
      <div className="sec">
        ...
        <div className="carousel-track" ref={foodTrackRef} onScroll={onFoodTrackScroll}>
          {[
            ["🍄","爱尚菌野生菌火锅","17号晚首选！菌子季鲜味绝顶，清鲜暖胃。📍锦江区东大街388号香槟广场3楼（春熙路太古里店）。","首夜暖胃必选","香槟广场"],
            ["🥟","经典成都名小吃","甜水面劲道甜辣、抄手鲜香、蛋烘糕（一定要加肉松！）。推荐龙抄手总店 📍锦江区春熙路南段6-8号（近中山广场，地铁2/3号线春熙路站D口）。","街巷寻味","龙抄手总店"],
            ["🍲","正宗川菜佳肴","层次丰富、百菜百味，回味悠长。推荐陈麻婆豆腐总店 📍青羊区东华门街51号；陶德砂锅春熙路店 📍锦江区总府路8号鸿德春熙中心3F；吃客 📍锦江区致民路48号（新南门地铁站B口）。","醇厚天府滋味","老字号三选"],
