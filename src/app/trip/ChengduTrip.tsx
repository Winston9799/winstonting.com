...
const DAYS: DayData[] = [
  {
    ...
    activities: [
      {
        time: "全天",
        title: "✈️ SQ842 飞抵成都 → 入住 Pagoda 酒店",
        desc: "10:00 抵达樟宜 T3，Marhaba Lounge 候机后 12:25 起飞，17:10 抵达 TFU；机场至酒店约 50km，入住高楼层城景双床房。",
        badges: [{ text: "提前 2.5h 抵达 T3" }],
      },
      {
        time: "晚餐",
        title: "🍄 爱尚菌·云南野生菌火锅（春熙路太古里店）",
        addr: "📍 成都市锦江区东大街388号香槟广场3楼",
        desc: "步行约6分钟，菌子季鲜蘑火锅，人均约¥104。",
      ...
      },
      {
        ...
        desc: "步行10-15分钟即达，廊桥夜景璀璨；可乘锦江夜游船（19:00-22:30，¥70-120，合江亭上船）收尾第一晚。",
      },
    ],
  },
  {
    ...
    activities: [
      {
        ...
        desc: "专车接送，导游车上讲解；近距离静赏熊猫啃竹、爬树等自然行为，门票已含。",
        badges: [{ text: "🎫 熊猫谷门票已含" }],
      },
      {
        time: "中午",
      ...
      },
      {
        time: "下午",
        title: "💧 都江堰水利工程",
        desc: "导游讲解鱼嘴分水堤、飞沙堰溢洪道、宝瓶口三大工程，感受两千年前无坝引水智慧。",
  ...
  },
  {
    ...
    activities: [
      {
        time: "上午-午后",
        title: "🙏 文殊院 → 荷花茶园 → 明婷饭店午餐",
        addr: "📍 地铁1/6号线文殊院站K口出站",
        desc: "10:00-12:30文殊院（免费，可领香）转荷花茶园，看变脸或拍照；12:30-14:00明婷饭店午餐，招牌脑花豆腐、奇香排骨。",
      },
      {
        time: "下午",
        title: "🏘️ 宽窄巷子 → 采耳体验",
        addr: "📍 宽窄巷子附近居民楼内（宽窄耳匠采耳）",
        desc: "14:00-17:30。先逛宽窄巷子（步行/骑车15-20分钟可达），16:00起体验采耳，30-60分钟约¥100。",
      },
      {
        time: "晚上",
        title: "🌃 抚琴夜市",
        desc: "18:00后打车约10分钟，本地人气夜市，小吃云集，营业至深夜。",
      },
    ],
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        title: "🏡 杜甫草堂",
        addr: "📍 成都市青羊区青华路37号",
        desc: "诗圣杜甫故居，茅屋竹林静谧清幽；时间充裕可顺游浣花溪公园、青羊宫或送仙桥古玩城。",
      },
      {
        time: "晚上",
        title: "🍷 蜀境雅韵宴 · 晚宴",
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        desc: "白夜花神诗空间打卡，步行至华姿路棕榈树巷道，全程约 1.5km，穿舒服的鞋即可。",
      },
      {
        time: "傍晚",
        title: "✈️ Winston 提前返程 · SQ843 返新加坡",
        addr: "📍 成都天府国际机场（TFU）T1 航站楼",
        desc: "Winston 今日先行搭乘 SQ843 返新，时刻与24号一致；出发前3h赴机场，打车约50分钟（¥120–150）。",
